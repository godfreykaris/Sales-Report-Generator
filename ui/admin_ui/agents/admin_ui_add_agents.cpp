...
// No namespace AdminUi {} block; using AdminUi:: qualifier directly
...
int AdminUi::AddAgentWindow::create_add_agent_window()
{
    ...
    if (ImGui::Button("Add", ImVec2(120, 0)))
    {
        ...
        bool found_unwanted_char = check_unwanted_characters(this->s_agent_name) || check_unwanted_characters(this->s_agent_location);
