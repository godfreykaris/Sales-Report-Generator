...
RUserUi::AddBrandWindow::AddBrandWindow(mongocxx::database db)
{
...
char RUserUi::AddBrandWindow::c_brand_name[128] = "";
char RUserUi::AddBrandWindow::c_n_brand_name[128] = "";

int RUserUi::AddBrandWindow::create_add_brand_window(std::string product_name, std::string& brand, std::vector<std::string>& quantities, std::vector<double>& selling_price, std::vector<double>& buying_price, std::vector<int>& number_of_items, std::string caller)
{
    ...
    if (this->quantity_win.finish == true && this->quantity_win.minput_error == false)
    {
        ...
        if (status == true)
        {
            ...
            this->quantity_win.minput_error = true;
        }
...
int RUserUi::RemoveBrandWindow::r_brand_current_item = 0;
RUserUi::RemoveBrandWindow::RemoveBrandWindow(mongocxx::database db)
{
	this->products_collection = db["Products"];
	this->stock = db["Stock"];
...
int RUserUi::RemoveBrandWindow::create_remove_brand_window()
{
