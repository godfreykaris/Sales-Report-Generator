...
RUserUi::AddQuantityWindow::AddQuantityWindow(mongocxx::database db)
{
...
int RUserUi::AddQuantityWindow::a_current_brand_index = 0;
char RUserUi::AddQuantityWindow::c_quantity_name[128] = "";
char RUserUi::AddQuantityWindow::c_new_brand_quantity_name[128] = "";
char RUserUi::AddQuantityWindow::c_new_quantity_name[128] = "";

int RUserUi::AddQuantityWindow::create_add_quantity_window(std::string& quantity, double& selling_price, double& buying_price, int& number_of_items, std::string caller)
{
...
int RUserUi::AddQuantityWindow::mset_brands(std::vector<std::string> vbrands)
{
    this->brands = "Select_";
...
int RUserUi::AddQuantityWindow::mset_products()
{
...
int RUserUi::AddQuantityWindow::admin_error_message(bool& error_flag)
{
...
int RUserUi::AddQuantityWindow::admin_confirm_message(int& confirm_flag)
{
...
int RUserUi::AddQuantityWindow::mset_quantities(std::vector<std::string> vquantities)
{
...
int RUserUi::RemoveQuantityWindow::r_quantity_brand_current_item = 0;
int RUserUi::RemoveQuantityWindow::r_quantity_current_item = 0;
RUserUi::RemoveQuantityWindow::RemoveQuantityWindow(mongocxx::database db)
{
	this->products_collection = db["Products"];
	this->stock = db["Stock"];
...
int RUserUi::RemoveQuantityWindow::create_remove_quantity_window()
{
	ImGui::PushStyleColor(ImGuiCol_Text, ImVec4(0.95f, 0.95f, 0.95f, 1.0f)); // Near-white text
    ImGui::PushStyleColor(ImGuiCol_WindowBg, ImVec4(0.13f, 0.14f, 0.15f, 1.0f)); // Dark charcoal background
    ImGui::PushStyleColor(ImGuiCol_Button, ImVec4(0.26f, 0.59f, 0.98f, 1.0f)); // Soft blue buttons
