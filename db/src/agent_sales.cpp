...
std::vector<std::vector<std::string>> get_agent_sales_arrays(mongocxx::collection agent_sales, int64_t id)
{
	...
	{
		details[0].push_back(std::string(agent_sale_data_view[std::string(index.get_string().value)]["Product"].get_string().value));
		details[1].push_back(std::string(agent_sale_data_view[std::string(index.get_string().value)]["Brand"].get_string().value));
		details[2].push_back(std::string(agent_sale_data_view[std::string(index.get_string().value)]["Quantity"].get_string().value));
		details[3].push_back(std::string(agent_sale_data_view[std::string(index.get_string().value)]["Season"].get_string().value));
		details[4].push_back(std::string(agent_sale_data_view[std::string(index.get_string().value)]["Age Group"].get_string().value));
		details[5].push_back(std::string(agent_sale_data_view[std::string(index.get_string().value)]["Gender"].get_string().value));
		details[6].push_back(std::string(agent_sale_data_view[std::string(index.get_string().value)]["Location"].get_string().value));

		item_count = agent_sale_data_view[std::string(index.get_string().value)]["Item Count"].get_int32();
